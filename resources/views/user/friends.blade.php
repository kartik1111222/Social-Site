...
<!-- Mirrored from friendkit.cssninja.io/navbar-v1-friends-grid-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 10:45:33 GMT -->
                ...
                <div class="filter-block">
                    ...
                    <i data-feather="check"></i>
                                        ...
                                        <li>
                                            <span class="item-icon">
                    <img
                      src="assets/img/vector/icons/logos/metamovies.svg"
                      alt=""
                    />
                  </span>
                                            <span
                    src="https://via.placeholder.com/150x150"
                    data-demo-class="item-name"
                    >Metamovies</span>
                                            <span class="checkmark">
                    <i data-feather="check"></i>
                  </span>
                ...
                <div class="card-row">
                    ...
                    <div class="card-flex friend-card">
                        ...
                        <div class="img-container">
                            <img class="avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets/users/profile . $value->profile')}}" alt="" />
                            <img class="country" src="{{asset('assets')}}/img/icons/flags/united-states-of-america.svg" alt="" />
                        </div>
...
<!-- Mirrored from friendkit.cssninja.io/navbar-v1-friends-grid-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 10:45:39 GMT -->
</html>