...
<body>
        ...
        <div class="container is-fluid">
            <div class="navbar-brand">
                <a href="index.html" class="navbar-item">
                    <img class="logo light-image" src="{{asset('assets')}}/img/vector/logo/friendkit-bold.svg" width="112" height="28" alt="" />
                    <img class="logo dark-image" src="{{asset('assets')}}/img/vector/logo/friendkit-white.svg" width="112" height="28" alt="" />
                </a>
            </div>
                                ...
                                <div class="nav-drop-body is-friend-requests">
                                    ...
                                    <div class="media">
                                        <figure class="media-left">
                                            <p class="image">
                                                <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets/users/profile/'. $request->user->profile)}}" alt="" />
                                            </p>
                                        </figure>
                                        ...
                                        <div class="media-right">
                                            <button onclick="approved_request({{$request->id}})" class="button icon-button is-solid grey-button raised">
                                                <i data-feather="user-plus"></i>
                                            </button>
                                            <button onclick="reject_request({{$request->id}})" class="button icon-button is-solid grey-button raised">
                            ...
                            <div class="inner">
                                ...
                                <div class="nav-drop-body is-friend-requests">
                                    ...
                                    <div class="media">
                                        <figure class="media-left">
                                            <p class="image">
                                                <img src="https://via.placeholder.com/150x150" data-demo-src="{{asset('assets')}}/img/avatars/edward.jpg" data-user-popover="1" alt="" />
                                            </p>
                                        </figure>
                                        <div class="media-content">
                                            <a href="#">Dan Walker</a>
                        ...
                        <div class="nav-drop is-account-dropdown">
                            <div class="inner">
                                ...
                                <div class="nav-drop-body account-items">
                                    ...
                                    <a href="{{route('user.profile')}}" class="account-item">
                                        <div class="media">
                                            <div class="icon-wrap">
                    ...
                    <div class="inner">
                        ...
                        <div class="nav-drop-body is-friend-requests">
                            ...
                            <div class="media">
                                <figure class="media-left">
                                    <p class="image">
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/edward.jpg" alt="" />
                                    </p>
                                </figure>
                                <div class="media-content">
                                    <a href="#">Dan Walker</a>
        ...
        <div class="navbar-menu">
            ...
            <div class="navbar-item has-dropdown is-active">
                <a href="navbar-v1-profile-main.html" class="navbar-link">
                    <img src="https://via.placeholder.com/150x150" data-demo-src="{{asset('assets')}}/img/avatars/jenna.png" alt="" />
                ...
                <div class="columns">
                    ...
                    <div class="column is-6">
                        ...
                        <div id="compose-card" class="card is-new-content">
                            ...
                            <div class="tabs-wrapper">
                                ...
                                <!-- Tab content -->
                                <form action="" type="POST" id="formdata" enctype="multipart/form-data">
                                    @csrf
                                    <div class="tab-content">
                                        <!-- Compose form -->`
                                        <div class="compose">
                                            <div class="compose-form">
                                                <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets/users/profile/' . auth()->user()->profile)}}" alt="" />
                                                <div class="control">
                                                    <textarea id="publish" class="textarea description" rows="3" placeholder="Write something about you..." name="description"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div id="tag-suboption" class="is-autocomplete is-suboption is-hidden">
                                                ...
                                                <div class="control">
                                                    <input id="users-autocpl" type="text" class="input tag_friend" name="tag_friend" class="tag_friend" placeholder="Who are you with?" />
                                                    <div class="icon">
                                                        <i data-feather="search"></i>
                                                    </div>
                                            ...
                                            <div id="activities-suboption" class="is-autocomplete is-suboption is-hidden">
                                                <div id="activities-autocpl-wrapper" class="control has-margin">
                                                    <input id="activities-autocpl" type="text" class="input activity" placeholder="What are you doing right now?" name="activity" />
                                                    <div class="icon">
                                                        <i data-feather="search"></i>
                                                    </div>
                                                    <div class="close-icon is-main">
                                            ...
                                            <div id="location-suboption" class="is-autocomplete is-suboption is-hidden">
                                                <div id="location-autocpl-wrapper" class="control is-location-wrapper has-margin">
                                                    <input id="location-autocpl" type="text" class="input location" placeholder="Where are you now?" name="location" />
                                                    <div class="icon">
                                            ...
                                            <div id="link-suboption" class="is-autocomplete is-suboption is-hidden">
                                                <div id="link-autocpl-wrapper" class="control is-location-wrapper has-margin">
                                                    <input id="link-autocpl" type="text" class="input share_link" placeholder="Enter the link URL" name="share_link" />
                                                    <div class="icon">
                                            ...
                                            <div id="gif-autocpl-wrapper" class="control is-gif-wrapper has-margin">
                                                ...
                                                <div class="gif-dropdown">
                                                    <div class="inner">
                                                        <div class="gif-block">
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/1.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/2.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/3.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/4.gif" alt="" />
                                                        </div>
                                                        <div class="gif-block">
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/5.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/6.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/7.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/8.gif" alt="" />
                                                        </div>
                                                        <div class="gif-block">
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/9.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/10.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/11.gif" alt="" />
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/demo/gif/12.gif" alt="" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="columns is-multiline is-full">
                                                ...
                                                <div class="column is-6 is-narrower">
                                                    <div class="compose-option is-centered">
                                                        ...
                                                        <!-- <input id="UploadImages123" type="file" /> -->
                                                        <input id="UploadImages123" type="file" accept=".png, .jpg, .jpeg" onchange="readURL(this)" name="media" />
                                                ...
                                                <div class="column is-6 is-narrower">
                                                    <div id="extended-show-activities" class="compose-option is-centered">
                                                        <img src="{{asset('assets')}}/img/icons/emoji/emoji-1.svg" alt="" />
                                        ...
                                        <div id="basic-options" class="compose-options">
                                            ...
                                            <div class="compose-option">
                                                <i data-feather="camera"></i>
                                                <span>Media</span>
                                                <input id="feed-upload-input-2" type="file" />
                                            </div>
                                            <!-- Mood action -->
                                            ...
                                            <div class="friends-list is-hidden">
                                                ...
                                                <div class="list-body">
                                                    ...
                                                    <div class="friend-block">
                                                        ...
                                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/edward.jpg" alt="" />
                                                    ...
                                                    <div class="friend-block">
                                                        ...
                                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/daniel.jpg" alt="" />
                                                    ...
                                                    <div class="friend-block">
                                                        ...
                                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/stella.jpg" alt="" />
                                                    ...
                                                    <div class="friend-block">
                                                        ...
                                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/david.jpg" alt="" />
                                                    ...
                                                    <div class="friend-block">
                                                        ...
                                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/nelly.png" alt="" />
                                        ...
                                        <div class="more-wrap">
                                            ...
                                            <!-- Publish button -->
                                            <button type="submit" id="publish-button" class="button is-solid accent-button is-fullwidth is-disabled">
                                                Publish
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div id="feed-post-1" class="card is-post">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    ...
                                    <div class="user-block">
                                        <div class="image">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets/users/profile/' . $post->user->profile)}}" data-user-popover="1" alt="" />
                                        </div>
                                        <div class="user-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="post-image">
                                        @if($post->media != null)
                                        <a data-fancybox="post1" data-lightbox-type="comments" data-thumb="{{asset('assets/images/media'. $post->media)}}" href="https://via.placeholder.com/1600x900" data-demo-href="{{asset('assets/images/media'. $post->media)}}">
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="likers-group">
                                        ...
                                        @php
                                        $like_post_data = App\Models\Like_post::where('post_id', $post->id)->with('user')->get();
                                        @endphp

                                        @foreach($like_post_data as $like_post)
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets/users/profile/'.  $like_post->user->profile)}}" data-user-popover="1" alt="" />
                                        @endforeach
                                        <!-- <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/david.jpg" data-user-popover="4" alt="" />
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/edward.jpeg" data-user-popover="5" alt="" />
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/milly.jpg" data-user-popover="7" alt="" /> -->
                                    </div>
                                    <!-- Followers text -->
                                    <div class="likers-text">
                                        <p>
                                            @foreach($like_post_data as $like_post)
                                            <a href="#">{{$like_post->user->firstname }}</a>,
                                            @endforeach
                                    ...
                                    <div class="social-count">
                                        <div class="likes-count">
                                            ...
                                            @php
                                            $like_post_count = App\Models\Like_post::where('post_id', $post->id)->count();
                                            @endphp
                                        ...
                                        @php
                                        $count_comments = App\Models\Comment::count();
                                        $count_subcomments = App\Models\subcomment::count();
                                        $total = $count_comments + $count_subcomments;
                                        @endphp
                            ...
                            <div class="comments-wrap is-hidden">
                                ...
                                <div class="comments-heading">
                                    <h4>Comments <small>({{$total}})</small></h4>
                                ...
                                <div class="comments-body has-slimscroll">
                                    ...
                                    <div class="media is-comment">
                                        ...
                                        <div class="media-left">
                                            <div class="image">
                                                <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets/users/profile/' . $comment->user->profile)}}" data-user-popover="1" alt="" />
                                            </div>
                                        </div>
                                        <!-- Content -->
                                        ...
                                        <div class="media-content">
                                            ...
                                            <div class="controls">
                                                <div class="like-count">
                                                    @if(in_array($comment->id, $like_comments))
                                                    <button type="submit" onclick="dislike_comment({{$comment->id}})" id="dislikecomment{{$comment->id}}"><i class="fa fa-thumbs-up" style="color: red"></i></button>
                                                    @else
                                                    <button type="submit" onclick="like_comment({{$comment->id}})" id="likecomment{{$comment->id}}"><i data-feather="thumbs-up"></i></button>
                                                    @endif

                                                    @php
                                                    $count_like_comments = App\Models\Like_comment::where('comment_id', $comment->id)->count();
                                                    @endphp
                                                    <span id="count_like_comments{{$comment->id}}">{{ $count_like_comments}}</span>
                                                </div>
                                                <div class="reply">
                                            ...
                                            <!-- Nested Comment -->
                                            <div class="media is-comment subcomment" style="display:none" id="subcomment-{{ $comment->id }}">
                                                <!-- User image -->

                                                <!-- Content -->
                                                <div class="media-content">
                                                    <a href="#">reply to {{$comment->user->firstname}} {{$comment->user->lastname}}</a>
                                                    <div class="field">
                                                        @php
                                                        $sub_comment = App\Models\subcomment::where('comment_id', $comment->id)->get();
                                                        @endphp

                                                        @foreach($sub_comment as $value)

                                                        <p class="control">
                                                            <textarea class="textarea" id="abc">{{$value->subcomment}}</textarea>
                                                        </p>
                                                    ...
                                                    <div class="field">
                                                        <p class="control">
                                                            <textarea class="textarea comment-textarea" rows="5" placeholder="Write a comment..." name="subcomment" id="abc"></textarea>
                                                        </p>
                                                        <button onclick="add_sub_comments({{$comment->id}})" type="submit">Add post</button>
                                                    </div>
                                                    <!-- Additional actions -->
                                                </div>
                                                <!-- Right side dropdown -->
                                ...
                                <div class="card-footer">
                                    <div class="media post-comment has-emojis">
                                        <!-- Comment Textarea -->
                                        <div class="media-content" style="display: none" id="comment_div">
                                            <div class="field">
                                                <p class="control">
                                                    <textarea class="textarea comment-textarea post_comment" rows="5" placeholder="Write a comment..." name="comment"></textarea>
                                                </p>
                                            </div>
                                            <!-- Additional actions -->
                                            <div class="actions">
                                                <div class="image is-32x32">
                                                    <img class="is-rounded" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets/users/profile/' . Auth::user()->profile)}}" data-user-popover="0" alt="" />
                                                </div>
                                                <div class="toolbar">
                                                    ...
                                                    <button onclick="add_comments({{$post->id}})" type="submit" class="button is-solid primary-button raised">Post Comment</button>
                    ...
                    <div class="column is-3">
                            ...
                            <div class="card-body no-padding">
                                ...
                                <div class="story-block">
                                    <div class="img-wrapper">
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/edward.jpg" data-user-popover="1" alt="" />
                                    </div>
                                    <div class="story-meta">
                                ...
                                <div class="story-block">
                                    <div class="img-wrapper">
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/bobby.jpg" data-user-popover="8" alt="" />
                                    </div>
                                    <div class="story-meta">
                                ...
                                <div class="story-block">
                                    <div class="img-wrapper">
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/elise.jpg" data-user-popover="6" alt="" />
                                    </div>
                                    <div class="story-meta">
                        ...
                        <div class="card">
                            ...
                            @php
                            $friendrequest_data = App\Models\Friendrequest::where('to_user_id',$data->id)->first();
                            @endphp
                            <div class="card-body no-padding">
                                <div class="add-friend-block transition-block">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets/users/profile/'. $data->profile)}}" data-user-popover="9" alt="" />
                                    <div class="page-meta">
                                    ...
                                    <div class="add-friend" id="suggestfriend">


                                        @if($friendrequest_data == null)
                                        <button onclick="friendrequest({{$data->id}})" type="submit" id="sendfriendequest{{$data->id}}"> <i data-feather="user-plus"></i> </button>
                                        @else
                                        <button type="submit"> <i data-feather="check"></i> </button>
                        ...
                        <!-- <div class="add-friend-block transition-block">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/lana.jpeg" data-user-popover="10" alt="" />
                                    <div class="page-meta">
                                ...
                                <div class="add-friend-block transition-block">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/gaelle.jpeg" data-user-popover="11" alt="" />
                                    <div class="page-meta">
                                ...
                                <div class="add-friend-block transition-block">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/mike.jpg" data-user-popover="12" alt="" />
                                    <div class="page-meta">
                                ...
                                <div class="add-friend-block transition-block">
                                    <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/rolf.jpg" data-user-popover="13" alt="" />
                                    <div class="page-meta">
                            ...
                            <div class="left-section">
                                ...
                                <div id="new-group-list" class="user-list has-slimscroll">
                                    ...
                                    <div class="friend-block" data-ref="ref-6">
                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/elise.jpg" alt="" />
                                    ...
                                    <div class="friend-block" data-ref="ref-7">
                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/bobby.jpg" alt="" />
                                    ...
                                    <div class="friend-block" data-ref="ref-8">
                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/dan.jpeg" alt="" />
                                    ...
                                    <div class="friend-block" data-ref="ref-9">
                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/gaelle.jpeg" alt="" />
                                    ...
                                    <div class="friend-block" data-ref="ref-10">
                                        <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/mike.jpg" alt="" />
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="content-block is-active">
                            <img src="{{asset('assets')}}/img/illustrations/cards/albums.svg" alt="" />
                            <div class="help-text">
                        ...
                        <div class="content-block">
                            <img src="{{asset('assets')}}/img/illustrations/cards/upload.svg" alt="" />
                            <div class="help-text">
        ...
        <div id="videos-help-modal" class="modal videos-help-modal is-xsmall has-light-bg">
            ...
            <div class="modal-content">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="content-block is-active">
                            <img src="{{asset('assets')}}/img/illustrations/cards/videotrip.svg" alt="" />
                            <div class="help-text">
                        ...
                        <div class="content-block">
                            <img src="{{asset('assets')}}/img/illustrations/cards/videocall.svg" alt="" />
                            <div class="help-text">
                                        ...
                                        <div class="dropdown is-spaced is-right dropdown-trigger">
                                            ...
                                            <div class="dropdown-menu has-margin" role="menu">
                                                <div class="dropdown-content">
                                                    ...
                                                    <a href="#" class="dropdown-item">
                                                        <div class="media">
                                                            <img src="https://via.placeholder.com/478x344" data-demo-src="{{asset('assets')}}/img/avatars/hanzo.svg" alt="" />
                                                            <div class="media-content">
                                                                <h3>Css Ninja</h3>
                                        ...
                                        <div class="media is-comment">
                                            <figure class="media-left">
                                                <p class="image is-32x32">
                                                    <img src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/edward.jpg" alt="" data-user-popover="1" />
                                                </p>
                                            </figure>
                                            <div class="media-content">
                                    ...
                                    <div class="dropdown is-accent page-dropdown">
                                        <div>
                                            <div class="button page-selector">
                                                <img src="https://via.placeholder.com/150x150" data-demo-src="{{asset('assets')}}/img/avatars/hanzo.svg" alt="" />
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <div class="dropdown-content">
                                                ...
                                                <div class="dropdown-item">
                                                    <div class="media">
                                                        <img src="https://via.placeholder.com/150x150" data-demo-src="{{asset('assets')}}/img/vector/icons/logos/nuclearjs.svg" alt="" />
                                                        <div class="media-content">
                                                            <h3>NuclearJs</h3>
                                                ...
                                                <div class="dropdown-item">
                                                    <div class="media">
                                                        <img src="https://via.placeholder.com/150x150" data-demo-src="{{asset('assets')}}/img/vector/icons/logos/slicer.svg" alt="" />
                                                        <div class="media-content">
                                                            <h3>Slicer</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="shared-publication">
                            <div class="featured-image">
                                <img id="share-modal-image" src="https://via.placeholder.com/1600x900" data-demo-src="assets/img/avatars/jenna.jpg" alt="" />
                            </div>
                            <div class="publication-meta">
                                <div class="inner-flex">
                                    <img id="share-modal-avatar" src="https://via.placeholder.com/300x300" data-demo-src="assets/img/avatars/edward.jpg" data-user-popover="1" alt="" />
                ...
                <div class="card">
                    ...
                    <div class="card-body has-text-centered">
                        <div class="image-wrap">
                            <img src="{{asset('assets')}}/img/illustrations/characters/no-stream.svg" alt="" />
                        </div>
                ...
                <div class="nav-start">
                    <div class="recipient-block">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300x300" data-demo-src="{{asset('assets')}}/img/avatars/edward.jpg" alt="" />
                        </div>
                        <div class="username">
                            <span>Dan Walker</span>
            ...
            <div id="chat-body" class="chat-body is-opened">
                ...
                <div id="dan-conversation" class="chat-body-inner has-slimscroll">
                    ...
                    <div class="chat-message is-received">
                        <img src="https://via.placeholder.com/300x300" data-demo-src="v/img/avatars/edward.jpg" alt="" />
            ...
            <div class="explorer-container">
                ...
                <div class="explore-list has-slimscroll">
                    ...
                    <a href="navbar-v1-feed.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/clover.svg" alt="" />
                        <h4>Feed</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-profile-friends.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/friends.svg" alt="" />
                        <h4>Friends</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-videos-home.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/videos.svg" alt="" />
                        <h4>Videos</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-pages-main.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/tag-euro.svg" alt="" />
                        <h4>Pages</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-ecommerce-products.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/cart.svg" alt="" />
                        <h4>Commerce</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-groups.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/house.svg" alt="" />
                        <h4>Interests</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-stories-main.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/chrono.svg" alt="" />
                        <h4>Stories</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-questions-home.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/question.svg" alt="" />
                        <h4>Questions</h4>
                    </a>
                    <!--item-->
                    <a href="news.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/news.svg" alt="" />
                        <h4>News</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-groups.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/cake.svg" alt="" />
                        <h4>Groups</h4>
                    </a>
                    <!--item-->
                    <a href="https://envato.com/" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/envato.svg" alt="" />
                        <h4>Envato</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-events.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/calendar.svg" alt="" />
                        <h4>Events</h4>
                    </a>
                    <!--item-->
                    <a href="https://cssninja.io/" target="_blank" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/pin.svg" alt="" />
                        <h4>Css Ninja</h4>
                    </a>
                    <!--item-->
                    <a href="elements.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/idea.svg" alt="" />
                        <h4>Elements</h4>
                    </a>
                    <!--item-->
                    <a href="navbar-v1-settings.html" class="explore-item">
                        <img src="{{asset('assets')}}/img/icons/explore/settings.svg" alt="" />
                        <h4>Settings</h4>
                    </a>
                </div>
            </div>
    ...
    <div id="end-tour-modal" class="modal end-tour-modal is-xsmall has-light-bg">
        ...
        <div class="modal-content">
            <div class="card">
                ...
                <div class="card-body has-text-centered">
                    <div class="image-wrap">
                        <img src="{{asset('assets')}}/img/vector/logo/friendkit.svg" alt="" />
                    </div>
    ...
    <script>
        ...
        function friendrequest($id) {
            ...
            var url = "{{route('user.add_friend_request')}}";
            ...
            $.ajax({
                ...
                , success: function(response) {
                    if (response.message) {
                        $("#sendfriendequest" + $id).html('<button type="submit"><i class="fa fa-check"></i></button>');
                        toastr.success(response.message, 'Success');
                    } else {

                        toastr.success('Friend request send successfully', 'Success');
    ...
    <script>
        ...
        function approved_request($id) {
            ...
            var url = "{{route('user.friend_request_status', ['_id_'])}}";
            $update_status_url = url.replace(['_id_'], $id);
            ...
            $.ajax({
                ...
                , success: function(response) {
                    if (response.message) {
                        ...
                        toastr.success('Friend request approved successfully', 'Success');
                    }
            ...
            $.ajax({
                ...
                , success: function(response) {
                    if (response.message) {
                        ...
                        toastr.success('Friend request rejected successfully', 'Success');
                    }
        ...
        function dislike_post($id) {
            event.preventDefault();
            event.stopPropagation();
            var url = "{{route('user.dislike_post')}}";
        ...
        function add_comments($id) {
            var url = "{{route('user.post_comment')}}";
            ...
            $.ajax({
                ...
                , success: function(response) {
                    if (response.message) {
                        ...
                        toastr.success('Comment post successfully', 'Success');
                    }
                    window.location.reload();
                }
                , error: function(xhr) {
        ...
        function reply(commentId) {
            // Hide all subcomments
            $('.subcomment').hide();

            // Show the subcomment for the clicked comment
        ...
        function add_sub_comments($id) {
            var sub_comment = $("#abc").val();
            var url = "{{route('user.post_sub_comment')}}";
            ...
            $.ajax({
                ...
                , success: function(response) {
                    if (response.message) {
                        ...
                        toastr.success('Sub Comment added successfully', 'Success');
                    }
                    window.location.reload();
                }
                , error: function(xhr) {
        ...
        function like_comment($id) {
            event.preventDefault();
            event.stopPropagation();
            var url = "{{route('user.like_comments')}}";
            ...
            $.ajax({
                ...
                , success: function(response) {
                    if (response.message) {
                        $("#count_like_comments" + $id).html(response.comment_like_count);
                        $("#likecomment" + $id).html('<button onclick="dislike_comment(' + $id + ')"><i class="fa fa-thumbs-up" style="color:red"></i></button>');
        ...
        function dislike_comment($id) {
            event.preventDefault();
            event.stopPropagation();
            var url = "{{route('user.dislike_comments')}}";
            ...
            $.ajax({
                ...
                , success: function(response) {
                    if (response.message) {
                        ...
                        $("#likecomment" + $id).html('<button onclick="like_comment(' + $id + ')"><i class="fa fa-thumbs-up"></i></button>');

                        toastr.success(response.message, 'Success');
                    } else {

                        toastr.success('disLike added successfully', 'Success');
                    }
